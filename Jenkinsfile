pipeline {
    ...
    stages {
        ...
        stage('Push Docker Image') {
            ...
            steps {
                script {
                    docker.withRegistry('https://registry.hub.docker.com', 'alamelu1992') {
         ...
         stage('DeployToStaging') {
            ...
            steps {
                    script {
                        ...
                        sh "docker run --restart always --name react-app -p 1233:80 -d alamelu1992/react-app:${env.BUILD_NUMBER}"
                    }
            }
        }
